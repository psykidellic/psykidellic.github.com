...
Money matters.  The problem if you focus purely on metrics such as "activations" is that you lose sight over other metrics such as customer loyalty.  Sometimes these other metrics are fuzzier and harder to measure.
...
It has been shown that the iOS the platform has greater "engagement":http://julianyap.com/2011/12/13/developers-make-more-money-on-ios-compared-to-android.html which in turn leads to greater revenue.  eBay VP of Mobile Steve Yankovich "recently stated":http://www.youtube.com/watch?v=yUYvbQnHZBk#t=46m20s that they 'Absolutely' see more iOS eBay buyers.  Steve also states that one issue with Android apps is discoverability and that many users do not know how to install an app on Android.
...
Android seriously needs to reconsider the metrics they use and place an emphasis on moving forward.
